...
down_revision: Union[str, Sequence[str], None] = '6eb68702b34d'
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('product_id', 'display_order', name='uix_product_display_order')
    )
    ...
    instance_status = postgresql.ENUM('AVAILABLE', 'MAINTENANCE', 'BROKEN', 'RETIRED', name='instancestatus', create_type=False)
